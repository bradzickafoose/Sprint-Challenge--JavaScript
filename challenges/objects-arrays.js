...
*/
class Dinosaur {
  constructor(dinosaurAttrs){
    this.name = dinosaurAttrs.name;
    this.diet = dinosaurAttrs.diet;
    this.weight = dinosaurAttrs.weight;
    this.length = dinosaurAttrs.length;
    this.period = dinosaurAttrs.period;
    this.roar = dinosaurAttrs.roar;
  }
}
...
console.log(`The ${tyrannosaurus.name} weighs a hefty ${tyrannosaurus.weight}. Lay off that second serving of ${stegosaurus.name}, Mr. ${tyrannosaurus.name} `);

// What was the diet of a velociraptor?
console.log(`The ${velociraptor.name}'s diet is ${velociraptor.diet}.`);
