...
• forEach iterates over a list and applies some operation to each list member.
...
• When used in a constructor, the super keyword must be used before the this keyword is used. 
